from ..cnn_funcs.initialize import *
...
def cnn_3L_model(X_train, Y_train, X_test, Y_test, learning_rate=0.009, num_epochs=100, minibatch_size=64, print_cost=True):
    """
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            seed = seed + 1
            minibatches = random_mini_batches_image(X_train, Y_train, minibatch_size, seed)
